 ...
 * @param {number} button
 */
export function on_mousedown(x, y, button) {
    wasm.on_mousedown(x, y, button);
}
 ...
 * @param {number} y
 */
export function on_mousemove(x, y) {
    wasm.on_mousemove(x, y);
}
 ...
 * @param {number} button
 */
export function on_mouseup(x, y, button) {
    wasm.on_mouseup(x, y, button);
}
